					...
					<div class="collapse navbar-collapse" id="example-navbar-collapse">
						<ul class="nav navbar-nav pull-left">
							...
							<c:if test="${empty sessionScope.user}">
								<li  class="nv">
									<a href="javascript:;" data-toggle="modal" data-target="#login" id="test">登录</a>
								</li>
								<li  class="nv">
								<a href="javascript:;" data-toggle="modal" data-target="#register">注册</a>
							</li>
							</c:if>
							<li  class="nv">
						...
						<div class="input-group col-md-3 pull-right" style="positon:relative;padding: 7px;width: 23%">
